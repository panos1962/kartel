...
# (ΤΜΗΜΑ), 26/4 (ΓΡΑΦΕΙΟ), 200/342 (ΑΡ. ΚΑΡΤΑΣ ΕΙΣΟΔΟΥ/ΕΞΟΔΟΥ). Επίσης, 
# λαμβάνει συγκεκριμένα πεδία των αδειών όλων των υπαλλήλων που λήγουν μετά
# την ημερομηνία εκκίνησης του συστήματος, η οποία πρέπει να είναι
# καταγεγραμμένη στο αρχείο "begin_date" στο directory "lib" της εφαρμογής.
#
